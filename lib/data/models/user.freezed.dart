...
class _$UserImpl implements _User {
  const _$UserImpl(
      ...
      @HiveField(5) this.profileImageUrl});
...
// "student", "teacher", "admin"
  ...
  @override
  String toString() {
    return 'User(id: $id, name: $name, email: $email, role: $role, phoneNumber: $phoneNumber, profileImageUrl: $profileImageUrl)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, email, role, phoneNumber, profileImageUrl);
...
abstract class _User implements User {
  const factory _User(
      ...
      @HiveField(5) final String? profileImageUrl}) = _$UserImpl;
  ...
  @HiveField(3)
  String get role;
  @override // "student", "teacher", "admin"
  @HiveField(4)
